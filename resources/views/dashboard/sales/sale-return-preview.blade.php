...
<head>
    ...
    <title>Sale Return Preview</title>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-4">
                    <div>
                        <h3 class="mb-1">Sale Return / Credit Note</h3>
                    ...
                    <div class="text-end">
                        ...
                        <div><strong>Status:</strong> {{ $sale->status ?? 'Unpaid' }}</div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <table class="table table-sm">
                            ...
                            <tr>
                                ...
                                <td class="text-end">{{ number_format($sale->received_amount ?? 0, 2) }}</td>
                            </tr>
                            <tr>
                                <th>Balance</th>
