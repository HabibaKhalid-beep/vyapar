...
<head>
  ...
  <title>Vyapar — Sales Return and Credit Notes</title>
      ...
      <div class="card-body">
        ...
        <div class="col-12 d-flex justify-content-between">
          ...
          <button class="btn btn-primary rounded"><span class="text-primary bg-light rounded-circle"
              style="padding: 0px 4px;">+</span> Add Delivery Challan</button>
        </div>
                ...
                <th class="d-flex">
                  ...
                  <div class="dropdown ms-3">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="dropdown-item">
                        <p class="mb-0" style="font-size: 11px;">Challan No</p>
                        <input type="text" class="bg-transparent border py-2 rounded w-100" style="outline:none;">
                ...
                <th class="d-flex">
                  ...
                  <div class="dropdown ms-3">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="dropdown-item">
                        <input type="checkbox"><span class="ms-1">Closed</span>
                      </li>
                      <div class="mt-2 ms-4">
                        <button class="btn rounded-pill" style="background-color: #EBEAEA;"><span
                            style="color: #71748E;">Clear</span></button>
