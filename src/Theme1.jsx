...
const Theme1 = ({ businessInfo, onCompanyClick, onLogoClick, logo, signature, onSignatureClick, selectedColor, terms, onTermsClick, invoiceData }) => {
  ...
  return (
    <div className="t1-wrapper">
      ...
      {isDeliveryChallan ? (
        <div className="t1-info-row t1-challan-info">
