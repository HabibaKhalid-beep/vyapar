...
document.addEventListener('keydown', (e) => {
    ...
    if (isAlt && key === 's') { e.preventDefault(); window.location.href = '/dashboard/sale/create'; }
    if (isAlt && key === 'p') { e.preventDefault(); window.location.href = '/dashboard/purchase-bill/create'; }
    if (isAlt && key === 'i') { e.preventDefault(); window.location.href = '/dashboard/payment-in'; }
    if (isAlt && key === 'o') { e.preventDefault(); window.location.href = '/dashboard/payment-out'; }
    if (isAlt && key === 'e') { e.preventDefault(); window.location.href = '/dashboard/expense'; }
    if (isAlt && key === 'n') { e.preventDefault(); window.location.href = '/dashboard/parties'; }
    if (isAlt && key === 'a') { e.preventDefault(); window.location.href = '/dashboard/items/create'; }
    if (isAlt && key === 'f') { e.preventDefault(); window.location.href = '/dashboard/sale-order/create'; }
    if (isAlt && key === 'g') { e.preventDefault(); window.location.href = '/dashboard/purchase-order/create'; }
    if (isAlt && key === 'd') { e.preventDefault(); window.location.href = '/dashboard/create-challan'; }
    if (isAlt && key === 'm') { e.preventDefault(); window.location.href = '/dashboard/estimates/create'; }
    if (isAlt && key === 'k') { e.preventDefault(); window.location.href = '/dashboard/proforma-invoice/create'; }
    if (isAlt && key === 'r') { e.preventDefault(); window.location.href = '/dashboard/sale-return/create'; }
    if (isAlt && key === 'l') { e.preventDefault(); window.location.href = '/dashboard/purchase-return/create'; }
    if (isAlt && key === 'b') { e.preventDefault(); window.location.href = '/dashboard/bank-accounts'; }
    if (isAlt && key === 'z') { e.preventDefault(); window.location.href = '/dashboard/sales/pos'; }

    if (isShift && key === 'h') { e.preventDefault(); window.location.href = '/dashboard'; }
    if (isShift && key === 'p') { e.preventDefault(); window.location.href = '/dashboard/parties'; }
    if (isShift && key === 'i') { e.preventDefault(); window.location.href = '/dashboard/items'; }
    if (isShift && key === 'r') { e.preventDefault(); window.location.href = '/dashboard/reports'; }
    if (isShift && key === 'b') { e.preventDefault(); window.location.href = '/dashboard/bank-accounts'; }
    if (isShift && key === 'c') { e.preventDefault(); window.location.href = '/dashboard/cash-in-hand'; }
    if (isShift && key === 'e') { e.preventDefault(); window.location.href = '/dashboard/expense'; }
    if (isShift && key === 'o') { e.preventDefault(); window.location.href = '/dashboard/sale-order'; }
    if (isShift && key === 's') { e.preventDefault(); window.location.href = '/dashboard/sales/estimate'; }
    if (isShift && key === 'u') { e.preventDefault(); window.location.href = '/dashboard/cheques'; }
    if (isShift && key === '1') { e.preventDefault(); window.location.href = '/dashboard/settings/general'; }
if (isCtrl && key === 'f') { e.preventDefault(); openGlobalSearch(); }
    if (isCtrl && key === 'p') { e.preventDefault(); window.print(); }
    if (isCtrl && key === 'y') { e.preventDefault(); const t = document.getElementById('privacyToggle'); if(t){ t.checked = !t.checked; togglePrivacyMode(t.checked); } }
});
